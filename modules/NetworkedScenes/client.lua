...
local function StealPainting(Entity, CB, CreateCam)
    ...
    local xOffset = GetEntityCoords(Entity) + GetEntityForwardVector(Entity) * -0.43

    local Enter = NetworkCreateSynchronisedScene(xOffset.x, xOffset.y, Coords.z - 1.17, Rotation, 2, true, false, -1, 0, 1.0)
    ...
    local LeftToRight = NetworkCreateSynchronisedScene(xOffset.x, xOffset.y, Coords.z - 1.17, Rotation, 2, true, false, -1, 0, 1.0)
    ...
    local RightToBottom = NetworkCreateSynchronisedScene(xOffset.x, xOffset.y, Coords.z - 1.17, Rotation, 2, true, false, -1, 0, 1.0)
    ...
    local BottomRightToLeft = NetworkCreateSynchronisedScene(xOffset.x, xOffset.y, Coords.z - 1.17, Rotation, 2, true, false, -1, 0, 1.0)
    ...
    local TopLeftToBottom = NetworkCreateSynchronisedScene(xOffset.x, xOffset.y, Coords.z - 1.17, Rotation, 2, true, false, -1, 0, 1.0)
    ...
    local ExitWithPainting = NetworkCreateSynchronisedScene(xOffset.x, xOffset.y, Coords.z - 1.17, Rotation, 2, true, false, -1, 0, 1.0)
